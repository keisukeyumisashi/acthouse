...
new setLoadingImage().forVsale(rakuten, vsaleFlg);
 if(rakuten.dispPc === 'on' || rakuten.size == "320x48" || rakuten.size == "320x50" || rakuten.size == "320x100" || rakuten.size == "160x900" || rakuten.size == "490x290" || rakuten.size == "240x210" || rakuten.size == "120x600" || rakuten.size == "520x160" || rakuten.size == "298x170" || rakuten.size == "160x1200" || rakuten.size == "294x355" || rakuten.size == "236x600" || rakuten.size == "236x850" || rakuten.size == "690x200" || rakuten.size == "560x180" || rakuten.size == "300x160" || rakuten.size == "300x500" || rakuten.size == "300x375" || rakuten.size == "200x1000" || rakuten.size == "600x290" || rakuten.size == "620x160" || rakuten.size == "300x600") {
 		if(isNewMW()) {
 			createPCIframeSpeed();
 		} else {
